...
static const int8_t akiko_spr_unko[] = {37,38,39,40};
...
//=============================================================================
// AYU
// $pals: skin:[1, 2, 3], hair:[37, 11, 10, 9], top:[8, 7, 6], eyes2:[15, 13, 12], wings:[19, 17, 18]
// $portraits: skin:[1, 7], hair:[16, 8], top:[23, 18], eyes2:[34, 39], wings:[34, 32]
// (kept, verified in-game, not in script): eyes:spr[5, 4]->port[25,29]
//=============================================================================
...
//=============================================================================
// DOPPEL
// $pals: skin:[1, 2, 3, 4], hair:[5, 6, 7, 25], top:[18, 19, 11], bottom:[8, 9, 10], acc:[17, 21, 12, 13, 24]
...
//=============================================================================
// IKUMI
// $pals: skin:[2, 3, 4, 5, 6], hair:[10, 11, 12, 13], acc:[17, 18, 19, 20], top:[21, 22, 23], eyes2:[38, 39, 40]
...
//=============================================================================
// KANO
// $pals: skin:[2, 3, 4, 5], top:[10, 11, 12, 13], bottom:[17, 18, 19, 20], eyes:[23, 24], acc:[14, 15, 16], hair:[6, 7, 8, 9]
// $portraits: skin:[2, 7], top:[8, 13], bottom:[14, 19], eyes:[20, 24], acc:[25, 29], hair:[34, 40]
//=============================================================================
...
//=============================================================================
// KAORI
// $pals: skin:[1, 2, 3, 4], hair:[19, 20, 21, 22], acc:[24, 25, 26], bottom:[9, 10, 11], eyes:[17, 18], top:[13, 8, 15]
// $portraits: skin:[1, 5], hair:[24, 29], acc:[33, 36], bottom:[17, 20], eyes:[37, 40], top:[6, 10]
//=============================================================================
...
//=============================================================================
// MAI
// $pals: skin:[1, 2, 3, 4], hair:[5, 6, 7, 14], bottom:[11, 12, 13], mai:[23, 24, 25], acc:[9, 10], eyes:[21, 22], ears:[17, 18]
// $portraits: skin:[2, 7], hair:[24, 17], bottom:[12, 8], mai:[13, 16], acc:[40, 36], eyes:[35, 32], ears:[13, 16]
// (our-fix override, script value differs): ears:port[29, 31] (script [13, 16])
//=============================================================================
...
//=============================================================================
// MAYU
// $pals: skin:[5, 4, 3, 2], hair:[9, 8, 7], top:[19, 18, 17], top2:[28, 27, 26], eyes2:[13, 12, 11, 10], bottom:[15, 14, 25]
...
//=============================================================================
// MIO
// $pals: skin:[1, 2, 3, 4], hair:[5, 6, 7], top:[21, 20, 19, 18], eyes:[22, 23], book:[14, 15], acc2:[31, 24, 25]
// $portraits: skin:[2, 7], hair:[8, 13], top:[21, 16], eyes:[22, 25], book:[34, 36], acc2:[26, 29]
//=============================================================================
...
//=============================================================================
// MISAKI
// $pals: skin:[2, 3, 4, 5], eyes2:[12, 15], top:[16, 18, 19, 17], hair:[6, 7, 8, 11], bottom:[9, 10, 14]
// $portraits: skin:[2, 8], eyes2:[10, 14], top:[15, 20], hair:[22, 30], bottom:[33, 39]
//=============================================================================
...
static const int8_t misaki_spr_hair[] = {6,7,8,11};
...
//=============================================================================
// MISUZU
// $pals: skin:[2, 3, 4, 5], hair:[6, 7, 8, 9], bottom:[10, 11, 12, 13], eyes:[14, 15, 16], acc:[17, 18, 19, 20], acc2:[21, 22, 23, 24], top:[25, 26, 27, 28], eyes2:[38, 39, 40]
...
//=============================================================================
// MIZUKA
// $pals: skin:[2, 3, 4, 5], hair:[20, 21, 22], top:[6, 7, 8], bottom:[9, 10, 11], acc:[17, 18, 19], acc2:[26, 27]
// $portraits: skin:[2, 7], hair:[27, 31], top:[8, 12], bottom:[13, 16], acc:[22, 26], acc2:[33, 36]
//=============================================================================
static const int8_t mizuka_spr_skin[] = {2,3,4,5};
static const int8_t mizuka_spr_hair[] = {20,21,22};
...
//=============================================================================
// NEYUKI
// $pals: skin:[3, 4, 5, 6, 7, 8], hair:[9, 10, 11, 12], top:[25, 26, 27, 28], kero:[22, 23, 24]
// $portraits: skin:[2, 8], hair:[8, 14], top:[17, 22], kero:[33, 37]
//=============================================================================
...
//=============================================================================
// RUMI
// $pals: skin:[1, 2, 3, 4], hair:[5, 6, 7], top:[18, 19, 11], bottom:[8, 9], acc:[17, 21, 12, 13, 24]
// $portraits: skin:[2, 7], hair:[8, 13], top:[30, 34], bottom:[14, 19], acc:[25, 29]
//=============================================================================
static const int8_t rumi_spr_skin[] = {1,2,3,4};
static const int8_t rumi_spr_hair[] = {5,6,7};
static const int8_t rumi_spr_top[] = {18,19,11};
static const int8_t rumi_spr_bottom[] = {8,9};
static const int8_t rumi_spr_acc[] = {17,21,12,13,24};

static const SpriteArea rumi_sprite[] = {
    {"skin", rumi_spr_skin, 4},
    {"hair", rumi_spr_hair, 3},
    {"top", rumi_spr_top, 3},
    {"bottom", rumi_spr_bottom, 2},
    {"acc", rumi_spr_acc, 5},
};
...
//=============================================================================
// SAYURI
// $pals: skin:[1, 2, 3, 4], hair:[17, 18, 19, 20], bottom:[9, 10, 11], acc:[5, 6, 7, 8], acc2:[21, 22, 23], eyes2:[30, 31, 32], eyes:[15, 14, 13], gun:[33, 34, 35]
...
//=============================================================================
// SHIORI
// $pals: skin:[8, 7, 6, 5], hair:[4, 3, 2, 1], top:[12, 11, 10, 9], bottom:[16, 15, 14, 13], acc:[20, 19, 18, 17], eyes:[30, 29], scarf1:[24, 22, 25], scarf2:[28, 27, 26]
...
//=============================================================================
// UNKNOWN
// $pals: skin:[2, 3, 4, 5], hair:[6, 7, 17, 19], top:[9, 20, 10, 18, 15], acc2:[12, 13], eyes:[11, 14], eyes2:[22, 23]
