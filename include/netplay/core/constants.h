...
inline constexpr uintptr_t kVaReadConfigByte = 0x00405A20;
inline constexpr uintptr_t kVaLoadControlBindings = 0x0040D140;
inline constexpr uintptr_t kVaLoadControlPreset = 0x0040D460;
